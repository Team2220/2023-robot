...
public class LowerScore3AsFarAsPossibleRedAuto extends SequentialCommandGroup {
  public LowerScore3AsFarAsPossibleRedAuto(Swerve swerve, Arm arm, Intake intake) {
