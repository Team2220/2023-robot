...
public class CenterBalV2 extends SequentialCommandGroup {
    public CenterBalV2(Swerve swerve, Arm arm, Intake intake) {
        addCommands(
            new JustScoreTheCubeHigh(swerve, arm, intake),
            new GoToCommand(swerve, new Position(0, Units.inchesToMeters(176.75) + 0.4, 180))
