    ...
    public V3CenterBal(Swerve swerve, Arm arm, Intake intake) {
        addCommands(
                new InstantCommand(
                        () -> swerve.setPose2d(
                                new Pose2d(
                                        new Translation2d(1.8453771028, 2.747899),
                ...
                new GoToCommand(
                        swerve,
                        new Pose2d(2.952708, 2.747899 + 0.377830 + 1.216025 + 0.379072 + 0.4138011028,
                ...
                new SetArmState(ArmStates.TRANSIT, arm)
                        ...
                        .alongWith(new GoToCommand(
                                swerve,
                                new Pose2d(2.952708, 2.747899 + 0.377830 + 2.747899 + 0.377830,
                                        Rotation2d.fromDegrees(0)))),
                // balance
