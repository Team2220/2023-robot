...
public class V2MidScoreL extends SequentialCommandGroup {
    public V2MidScoreL(Swerve swerve, Arm arm, Intake intake) {
        addCommands(
                new InstantCommand(
                        () -> swerve.setPose2d(
                                new Pose2d(
                ...
                new GoToCommand(swerve, new Pose2d(3.7757771028, 5.295900,
