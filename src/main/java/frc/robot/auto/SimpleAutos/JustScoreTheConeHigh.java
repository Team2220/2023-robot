...
public class JustScoreTheConeHigh extends SequentialCommandGroup {
    public JustScoreTheConeHigh(Swerve swerve, Arm arm, Intake intake) {
        addCommands(
            ...
            new SetArmState(ArmStates.HIGH_CONE_NODE, arm),
