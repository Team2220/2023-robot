...
import frc.robot.auto.Finished.WireMobile;
import frc.robot.auto.SimpleAutos.JustScoreTheConeHigh;
import frc.robot.auto.SimpleAutos.JustScoreTheConeLow;
import frc.robot.auto.SimpleAutos.JustScoreTheConeMid;
...
import frc.robot.auto.Finished.NonWireMobile;
...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                autoChooser.addOption(new WireMobile(m_swerve, m_intake, m_arm));
                autoChooser.addOption(new NonWireBal(m_swerve, m_intake, m_arm));
                autoChooser.addOption(new NonWireMobile(m_swerve, m_intake, m_arm));
