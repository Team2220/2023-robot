...
public final class GeneralConfig {
    ...
    // Width of the drivetrain, again, measured from middle of wheel to middle of
    // wheel
    // Doesn't need to be super accurate, just as a ratio of len to width
    ...
    public static final TunableDouble DT_MAX_VEL = new TunableDouble("DT_MAX_VEL", 4, SWERVE_SHUFFLEBOARD_ENABLED,
            "Swerve").setSpot(4, 0);

    // Acceleration restrictions m/s2
    public static final TunableDouble DT_MAX_ACCEL = new TunableDouble("DT_MAX_ACCEL", 60, SWERVE_SHUFFLEBOARD_ENABLED,
            "Swerve").setSpot(5, 0);

    // Rotational velocity restrictions deg/s
    public static final TunableDouble DT_MAX_ROT_VEL = new TunableDouble("DT_MAX_ROT_VEL", 500,
            SWERVE_SHUFFLEBOARD_ENABLED, "Swerve").setSpot(4, 1);

    // Rotational acceleration restrictions deg/s2
    public static final TunableDouble DT_MAX_ROT_ACCEL = new TunableDouble("DT_MAX_ROT_ACCEL", 2000,
            SWERVE_SHUFFLEBOARD_ENABLED, "Swerve")
            .setSpot(5, 1);
